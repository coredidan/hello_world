...
- **Финансовая аналитика** (NEW!):
  - Расчёт стоимости каналов с поддержкой разных моделей ценообразования
  - Модели: фиксированная ставка, за Mbps, ступенчатая, по трафику
...
├── forecasting/       # Прогнозирование (NEW!)
├── recommendations/   # Интеллектуальные рекомендации (NEW!)
